...
AS
    RETURN (
           ...
           SELECT   ad.ARTI AS H_ARTI
                  , ll.IdLotto AS H_IdLotto
                  , ad.NUM_COMMESSA AS H_NUM_COMMESSA
                  , a.DSCR AS H_DSCR
                  , STUFF(( SELECT CHAR(10) + qry.NOTE AS [text()]
           ...
           WHERE    act.STAB = @Stab
                    ...
                    AND ( ad.MAGA_GEST = @magaHost
                          ...
                          OR @magaHost = '' )
                    AND ad.FLG_KANBAN = 0
           GROUP BY act.STAB, act.MAGA, act.TIPO_NOMI, act.NOMI, N.RAG_SOC, act.TIPO_DOCU, act.ANNO_DOCU, act.NUME_DOCU, act.STATO, act.D_DOCU, ad.ARTI, a.id, ll.IdLotto, a.DSCR, ad.UMIS, a.UMIS_STD, ad.NUM_COMMESSA, ll.LOTTO, ll.DT_LOTTO, ll.DT_SCAD, ad1.RAGG_RF, ad.FLG_FREEPASS, ad.CAUS_BLOC );